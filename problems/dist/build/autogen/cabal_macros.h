...
/* package haskell-problems-0.1.0.0 */
#define VERSION_haskell_problems "0.1.0.0"
#define MIN_VERSION_haskell_problems(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "haskell-problems-0.1.0.0"

#define CURRENT_PACKAGE_KEY "haskell-problems-0.1.0.0"
